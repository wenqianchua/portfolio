...
export function UnlockGate({ onUnlock, projectTitle }: Props) {
  ...
  return (
    <div
      className={`max-w-lg mx-auto py-16 px-6 text-center transition-all
        ${shake ? 'animate-shake' : ''}`}
    >
      ...
      <p className="text-xs text-zinc-400 mt-8">
        ...
        <a
          href="https://www.linkedin.com/in/wenqianchua/"
          target="_blank"
